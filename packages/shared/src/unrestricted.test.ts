...
describe('unrestrictedFromEnv', () => {
  it('reads DETUNNEL_UNRESTRICTED', () => {
    expect(unrestrictedFromEnv({ DETUNNEL_UNRESTRICTED: '1' })).toBe(true);
    expect(unrestrictedFromEnv({ DETUNNEL_UNRESTRICTED: 'true' })).toBe(true);
    expect(unrestrictedFromEnv({ DETUNNEL_UNRESTRICTED: '0' })).toBe(false);
...
describe('isUnrestricted', () => {
  ...
  it('honors an explicit off setting or env override', () => {
    ...
    expect(isUnrestricted({ DETUNNEL_UNRESTRICTED: '0' }, 'true')).toBe(false);
    expect(isUnrestricted({ DETUNNEL_UNRESTRICTED: '1' }, 'false')).toBe(true);
