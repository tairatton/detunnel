...
export function contextTools(context: McpToolContext, engine: ContextEngine): McpToolDefinition[] {
  ...
  return [
    defineTool({
      ...
      description: 'Aggregate ranked workspace context with snippets, symbols, test relevance, economy metadata, and continuation; automatic discovery can be explicitly expanded.',
      permission: 'READ',
