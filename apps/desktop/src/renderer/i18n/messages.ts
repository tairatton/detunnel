...
export const th: Messages = {
  ...
  'tunnel.needProfile': 'ยังไม่มีโปรไฟล์ detunnel.yaml',
  ...
  'live.waitingTunnel': 'ยังไม่มีไฟล์ tunnel log — รัน tunnel ด้วยสคริปต์ start-detunnel-tunnel.ps1 หรือกด Start Tunnel',
...
export const en: Messages = {
  ...
  'tunnel.needProfile': 'Missing detunnel.yaml tunnel profile',
  ...
  'live.waitingTunnel': 'No tunnel log file yet — run start-detunnel-tunnel.ps1 or press Start Tunnel',
